...
mardi + mars + 16h-19h
2 roues + nuit avec éclairage + en agglo + hors intersection + voie communale birectionnelle

Classe 2
blessé léger + conducteur + hommes + 35-44 ans + depmt entre 1 et 2 millions d'hab
jeudi + septembre + 10h-15h
voiture + plein jour + en agglo + hors intersection + voie communale birectionnelle
...
mardi + août + 16h-19h
2 roues + plein jour  + en agglo + à une intersection + voie communale birectionnelle
...
lapply(res_kmodes$category, function(.x) head(as.data.frame(.x),n=8))
```
