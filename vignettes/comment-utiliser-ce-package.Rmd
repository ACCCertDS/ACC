...
lieux <- lieux %>% 
  select(-larrout) %>% #On retire la variable larrout
  mutate(libl_catr=case_when(
                            catr==1 ~ "Autoroute",
